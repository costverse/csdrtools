...
---------------------------- **REVIEWER RESPONSE** ----------------------------
```{r eval=FALSE, include=FALSE}
# --------------------- INSERT RESPONSE BELOW THIS CHUNK --------------------- 
```



```{r eval=FALSE, include=FALSE}
# --------------------- INSERT RESPONSE ABOVE THIS CHUNK --------------------- 
```
</div>
...
wbs_without_0_units %>% 
  ...
  gt::tab_options(table.font.size = "8", data_row.padding = gt::px(1)) %>% gt::cols_align(c("left"), columns = c("WBSElementID",	"WBSElementName")) %>%
  gt::fmt_number(columns = c(3:ncol(wbs_without_0_units)), drop_trailing_zeros = TRUE)
```
...
```{r}
PctComplete_Hours_vs_Dollars_Nonrecurring <- csdr %>% 
  filter(is_lowest              == "TRUE",
         UnitOfMeasure          == "Hours",
         Recurring_Nonrecurring == "Nonrecurring",
         !is.na(FunctionalElement)) %>% 
...
PctComplete_Hours_vs_Dollars_Nonrecurring  %>% 
  gt::gt() %>% 
...
```{r}
PctComplete_Hours_vs_Dollars_Recurring <- csdr %>% 
  filter(is_lowest              == "TRUE",
         UnitOfMeasure          == "Hours",
         Recurring_Nonrecurring == "Recurring",
         !is.na(FunctionalElement)) %>% 
...
PctComplete_Hours_vs_Dollars_Recurring %>% 
  gt::gt() %>% 
...
```{r}
laborRate_Nonrecurring_ToDate <- csdr %>% 
  filter(is_lowest == "TRUE",
         UnitOfMeasure != "Units",
...
laborRate_Nonrecurring_ToDate %>% 
  ...
  gt::tab_options(table.font.size = "8", data_row.padding = gt::px(1)) %>% gt::cols_align(c("left"), columns = c("WBSElementID",	"WBSElementName")) %>%
  gt::fmt_currency(columns = c(3:ncol(laborRate_Nonrecurring_ToDate)))
```
...
```{r}
laborRate_Recurring_ToDate <- csdr %>% 
  filter(is_lowest == "TRUE",
         UnitOfMeasure != "Units",
         ToDate_AtCompletion == "ToDate",
         Recurring_Nonrecurring == "Recurring",
...
laborRate_Recurring_ToDate %>% 
  gt::gt() %>% 
  gt::tab_header(title = "Average Recurring Labor Rate To Date by Functional Element", 
                 subtitle = "Includes Only Lowest Level WBS with Reported Hours and Dollars") %>% 
  gt::tab_options(table.font.size = "8", data_row.padding = gt::px(1)) %>% gt::cols_align(c("left"), columns = c("WBSElementID",	"WBSElementName")) %>%
  gt::fmt_currency(columns = c(3:ncol(laborRate_Recurring_ToDate)))
```
...
```{r}
laborRate_Nonrecurring_AtCompletion <- csdr %>% 
  filter(is_lowest == "TRUE",
         UnitOfMeasure != "Units",
...
laborRate_Nonrecurring_AtCompletion %>% 
  gt::gt() %>% 
  gt::tab_header(title = "Average Nonrecurring Labor Rate At Completion by Functional Element", 
                 subtitle = "Includes Only Lowest Level WBS with Reported Hours and Dollars") %>% 
  gt::tab_options(table.font.size = "8", data_row.padding = gt::px(1)) %>% gt::cols_align(c("left"), columns = c("WBSElementID",	"WBSElementName")) %>%
  gt::fmt_currency(columns = c(3:ncol(laborRate_Nonrecurring_AtCompletion)))
```
...
```{r}
laborRate_Recurring_AtCompletion <- csdr %>% 
  filter(is_lowest == "TRUE",
         UnitOfMeasure != "Units",
         ToDate_AtCompletion == "AtCompletion",
         Recurring_Nonrecurring == "Recurring",
...
laborRate_Recurring_AtCompletion %>% 
  gt::gt() %>% 
  gt::tab_header(title = "Average Recurring Labor Rate At Completion by Functional Element", 
                 subtitle = "Includes Only Lowest Level WBS with Reported Hours and Dollars") %>% 
  gt::tab_options(table.font.size = "8", data_row.padding = gt::px(1)) %>% gt::cols_align(c("left"), columns = c("WBSElementID",	"WBSElementName")) %>%
  gt::fmt_currency(columns = c(3:ncol(laborRate_Recurring_AtCompletion)))
```
...
## Average Overhead Factors

### Average Overhead Factor by Functional Element
...
```{r}
ovhFct_Nonrecurring_ToDate <- csdr %>% 
  filter(is_lowest == "TRUE",
         UnitOfMeasure != "Units",
         Recurring_Nonrecurring == "Nonrecurring",
         ToDate_AtCompletion == "ToDate",
...
ovhFct_Nonrecurring_ToDate %>% 
  gt::gt() %>% 
  gt::tab_header(title = "Nonrecurring Overhead Factor To Date by WBS Element", 
                 subtitle = "Includes Only Lowest Level WBS with Reported Dollars") %>% 
  gt::tab_options(table.font.size = "8", data_row.padding = gt::px(1)) %>% gt::cols_align(c("left"), columns = c("WBSElementID",	"WBSElementName")) %>%
  gt::fmt_percent(columns = c(3:ncol(ovhFct_Nonrecurring_ToDate)), decimals = 1)
```
...
ovhFct_Recurring_ToDate %>% 
  gt::gt() %>% 
  gt::tab_header(title = "Recurring Overhead Factor To Date by WBS Element", 
                 subtitle = "Includes Only Lowest Level WBS with Reported Dollars") %>% 
  gt::tab_options(table.font.size = "8", data_row.padding = gt::px(1)) %>% gt::cols_align(c("left"), columns = c("WBSElementID",	"WBSElementName")) %>%
  gt::fmt_percent(columns = c(3:ncol(ovhFct_Recurring_ToDate)), decimals = 1)
```
...
```{r}
ovhFct_Nonrecurring_AtCompletion <- csdr %>% 
  filter(is_lowest == "TRUE",
         UnitOfMeasure != "Units",
         Recurring_Nonrecurring == "AtCompletion",
         ToDate_AtCompletion == "ToDate",
         !is.na(FunctionalCategory)) %>% 
  pivot_wider(id_cols     = c(WBSElementID,
                              WBSElementName),
...
ovhFct_Nonrecurring_AtCompletion %>% 
  gt::gt() %>% 
  gt::tab_header(title = "Nonrecurring Overhead Factor At Completion by WBS Element", 
                 subtitle = "Includes Only Lowest Level WBS with Reported Dollars") %>% 
  gt::tab_options(table.font.size = "8", data_row.padding = gt::px(1)) %>% gt::cols_align(c("left"), columns = c("WBSElementID",	"WBSElementName")) %>%
  gt::fmt_percent(columns = c(3:ncol(ovhFct_Nonrecurring_AtCompletion)), decimals = 1)
```
...
```{r}
ovhFct_Recurring_AtCompletion <- csdr %>% 
  filter(is_lowest == "TRUE",
         UnitOfMeasure != "Units",
         Recurring_Nonrecurring == "Recurring",
         ToDate_AtCompletion == "AtCompletion",
...
ovhFct_Recurring_AtCompletion %>% 
  gt::gt() %>% 
  gt::tab_header(title = "Recurring Overhead Factor At Completion by WBS Element", 
                 subtitle = "Includes Only Lowest Level WBS with Reported Dollars") %>% 
  gt::tab_options(table.font.size = "8", data_row.padding = gt::px(1)) %>% gt::cols_align(c("left"), columns = c("WBSElementID",	"WBSElementName")) %>%
  gt::fmt_percent(columns = c(3:ncol(ovhFct_Recurring_AtCompletion)), decimals = 1)
```

#### Average Direct Engineering Overhead Rate To Date vs. At Completion
...
#### Average Manufacturing Operations Overhead Factor To Date vs. At Completion
...
#### Average Material Handling/Overhead Factor To Date vs. At Completion
...
# %>% 
#   pivot_longer(cols = -c(1:2), names_to = "ToDate_AtCompletion", values_to = "Value") %>% 
#   ggplot(aes(x = paste0(as.character(WBSElementID), " - ", WBSElementName), y = Value)) +
#   geom_point() +
#   coord_flip()
```
